...
function [mak_big, mak_mid, mak_sml, M_eventgrid, n_mak, particle_contact_grid, particle_contact_total, pfd_Cw_initial,...
...
pfd_z = (0:-0.05:-1.0)'; % maximum length of a macropore
...
mak_big = pfd_z(length(pfd_z)); % depth distribution of macropores within pfd
mak_mid = round(mak_big*0.8,1);
mak_sml = round(mak_big*0.5,1);
