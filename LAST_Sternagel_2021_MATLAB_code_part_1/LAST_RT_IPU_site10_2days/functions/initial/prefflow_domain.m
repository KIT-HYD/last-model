...
pfd_z = (0:-0.05:-0.8)'; % maximum length of a macropore
pfd_D = (5/(10*100)); % diameter of macropore (mm)
n_mak = 92; % amount of macropores within the domain
...
mak_big = -0.8; % depth distribution of macropores within pfd
mak_mid = -0.5;
mak_sml = -0.2;

rate_big = 0.14; % distribution factors for the proportion of macropores and diffusive mixing masses
rate_mid = 0.37; % when adjusting the depth of the biggest macropores, please do it by adjusting "pfd_z" above
rate_sml = 0.49; 
