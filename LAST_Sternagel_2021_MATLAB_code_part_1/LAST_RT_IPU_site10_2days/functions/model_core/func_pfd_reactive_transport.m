...
%       if ((pfd_Ct_deg(i) + sum(Cw_ret_particle .* (pfd_m / rho))) / pfd_dz(i)) > (((particles(i) * pfd_m) / rho) * pfd_Cw_ret(i)) / pfd_dz(i) 
%           Cw_ret_particle = ((((pfd_Cw_ret(i) * pfd_theta(i) * pfd_dz(i)) - pfd_Ct_deg(i)) / particles(i)) / (pfd_m / rho)) * ones(particles(i),1);
%       end
...
%       if (((pfd_Cw_ret(i) + ((m_des / particles(i)) / (pfd_m / rho))) * ((particles(i) * pfd_m) / rho)) / pfd_dz(i)) > (pfd_Ct_deg(i) / pfd_dz(i))
%           m_des = pfd_Ct_deg(i) - (pfd_Cw_ret(i) * (pfd_m / rho) * particles(i));
%       end
