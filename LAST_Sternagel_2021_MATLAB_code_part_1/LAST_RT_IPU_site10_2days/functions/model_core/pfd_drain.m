...
function [pfd_conc_output,c_particle, pfd_particles, pfd_particle_output, pfd_age, pfd_Cw, pfd_Cw_event, pfd_theta, pfd_position_znew, position_z] = ... % output arguments
            pfd_drain... % function
