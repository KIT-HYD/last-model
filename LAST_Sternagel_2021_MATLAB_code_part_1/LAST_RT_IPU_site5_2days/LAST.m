...
t_end = 86400 * 2; % end time of simulation (default: 1 day = 86400 s)
...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
% initialisation of reactive transport parameters in matrix
...
halflife = [23,23]; % half-life time in days, first value for topsoil and second value for subsoil
...
sorption_koeff = [2.83,2.83]; % Freundlich Isotherm coefficient in mL/g (taken from PPDB), first value for topsoil and second value for subsoil
...
% initialisation of reactive transport parameters in pfd (no depth distribution, equal
...
m_slt_surface = 0.0005; % only for simulation of IPU leaching at site 5; applied IPU mass (0.5 g) on surface 1 day before irrigation start
m_surface = 1; % only for simulation of IPU leaching at site 5; water mass (1 l) used for initial IPU application
