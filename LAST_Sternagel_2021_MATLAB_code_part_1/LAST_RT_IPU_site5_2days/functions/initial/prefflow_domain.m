...
n_mak = 0; % amount of macropores within the domain
...
rate_big = 0.4; % distribution factors for the proportion of macropores and diffusive mixing masses
rate_mid = 0.2; % when adjusting the depth of the biggest macropores, please do it by adjusting "pfd_z" above
rate_sml = 0.4; 
